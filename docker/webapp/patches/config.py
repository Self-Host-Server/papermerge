...
class Settings(BaseSettings):
    ...
    # Role name (must exist in the `roles` table) whose permissions are
    # granted as a baseline to any JWT-authenticated non-superuser who
    # didn't match a role/group claim -- see get_current_user() patch.
    papermerge__auth__oidc_default_role: str | None = None
